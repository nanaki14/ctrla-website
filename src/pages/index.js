...
const members = [
  ...
  },
  {
    icon: sukiamaki,
    name: 'sukiamaki',
    detail: '96年生まれ、東京田舎出身横浜田舎在住。高校3年間の青春とデータ通信量をクラブイベント配信に捧げ、浪人。当時のアニソンリミックスやネットレーベル音楽から影響を受ける。2016年よりVJ活動・2017年よりDJ活動を開始し、主に幾何学的な映像を好む。秋葉原や渋谷を中心に活動中。好きな食べ物は生ハム。',
    social: [
      {
        name: 'twitter',
        link: ''
      ...
      <ContentsInner>
        ...
        <SectionContainer>
          <GridCcntainer>
            ...
            <GridItem column={2}>
              <PrimaryText>
              Ctrl+Aは、秋葉原MOGRAにて奇数月の金曜日に開催されているDJイベントです。<br />
「Ctrl+A」には文化の発信地である「Akihabara」を「包括する」という意味が込められ、アニメソングやポップス、インターネット音楽と、カラフルなビジュアル表現や照明演出で空間を彩るスタイルを得意としています。 Ctrl+Aが秋葉原であなたの週末の始まりを「少し楽しくて」、「ちょっとオシャレ」な気持ちにするお手伝いをします。
              </PrimaryText>
            </GridItem>
          </GridCcntainer>
        </SectionContainer>
